        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MarkAnswer = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TestDetails", x => new { x.TestId, x.QuestionId, x.AnswerId });
                    table.ForeignKey(
                        name: "FK_TestDetails_Answers_AnswerId",
                        column: x => x.AnswerId,
